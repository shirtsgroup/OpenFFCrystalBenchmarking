...
axs[0].set_title('OpenMM Minimization Only')
...
print('RMSD OFF 1.0 Mean: %s nm' % np.mean(off1_rmsd))
print('RMSD OFF 2.0 Mean: %s nm' % np.mean(off2_rmsd))
print('RMSD (box min) OFF 1.0 Mean: %s nm' % np.mean(off1_box_rmsd))
print('RMSD (box min) OFF 2.0 Mean: %s nm' % np.mean(off2_box_rmsd))
